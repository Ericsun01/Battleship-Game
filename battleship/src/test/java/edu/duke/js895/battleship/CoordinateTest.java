...
public class CoordinateTest {
  ...
  public void test_row_and_column() {
    ...
    assertEquals(5, c1.getRow());
    assertEquals(8, c1.getColumn());
  }

  // @Test
  // public void test_invalid_dimensions() {
  //   assertThrows(IllegalArgumentException.class, ()->new Coordinate(30, 8));
  //   assertThrows(IllegalArgumentException.class, ()->new Coordinate(15, 15));
  // }
  ...
  public void test_string_constructor_error_cases() {
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("00")); // invalid row letter
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("AA")); // invalid col number
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("@0")); // invalid row letter
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("[0"));
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("A/")); // invalid col number
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("A:"));
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("A")); // length not enough
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("A12")); // length out range
  }
  ...
  public void test_toString() {
    ...
    assertNotEquals("(2, 1)", c1.toString());
  }
